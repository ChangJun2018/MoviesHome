<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="list.aspx.cs" Inherits="list" Title="视频之家MoviesHome" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	<div class="container">
        ...
        <div style="width:1003px;">
        	<div style="width:240; height:300px" class="left"><img src="images/list/notice/gj.png" width="200" height="250"><br>港囧
            <span class="right" style="margin-right:50px; color: #F63">7.7</span><br>徐峥包贝尔香港暴走</div>
            <div class="left" style="margin-left:5px">
            <div style="width:7000; height:160px">
            	<div style="width:185; height:150px" class="left">
                    <img src="images/list/notice/nsdzz.png" width="183" height="102"><br/>
                    年兽大作战
                </div>
                <div style="width:185; height:150px" class="left">
                    <img src="images/list/notice/nsdzz.png" width="183" height="102"><br/>
                ...
                <div style="width:185; height:150px" class="left">
                    <img src="images/list/notice/nsdzz.png" width="183" height="102"><br/>
                    年兽大作战
                </div><div style="width:185; height:150px" class="left">
                    <img src="images/list/notice/nsdzz.png" width="183" height="102"><br/>
                    年兽大作战
                </div>
            </div>
        ...
        <div style="width:1003px;">
            ...
            <div style="width:7000; height:160px">
            	<div style="width:185; height:150px" class="left">
                    <img src="images/list/notice/tsgl.png" width="183" height="102"><br/>
                    泰山归来
                </div>
                <div style="width:185; height:150px" class="left">
                    <img src="images/list/notice/tsgl.png" width="183" height="102"><br/>
